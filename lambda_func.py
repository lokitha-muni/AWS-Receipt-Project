...
DYNAMODB_TABLE = os.environ.get('DYNAMODB_TABLE', 'receipts-lokitha')
SES_SENDER_EMAIL = os.environ.get('SES_SENDER_EMAIL', 'lokithamuni3@gmail.com')
SES_RECIPIENT_EMAIL = os.environ.get('SES_RECIPIENT_EMAIL', 'lokithamuni3@gmail.com')
